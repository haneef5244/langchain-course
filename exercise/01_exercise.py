...
def implement_set_api_key(api_key):
    ...
    if "GROQ_API_KEY" not in os.environ or os.environ["GROG_API_KEY"] != api_key:
...
def implement_compare_models(prompt):
    ...
    llama_3 = implement_llama_3_3_model()

    return {
        llama_4.model: implement_query_model(model=llama_4, prompt=prompt),
        llama_3.model: implement_query_model(model=llama_3, prompt=prompt),
    }    
    # pass
